...
use crate::common::*;
/////////////////////////////////////////////
// The #[loggable]     | TestCases. (trait, fn in macro)
// Attribute Values    | c: Copied from `trait_fn` and adapted                      |   Notes
//---------------------|------------------------------------------------------------|-------------
...
fn trait_macro() {
...

    {
        // Absent
        trait Tr {
            // TODO: Document this ("Other attrs") {
            ...
            trait_contents!{}   
            // At the initial stage expands to:
            // ```
            // // No any other attrs.
            // #[loggable_block_contents(prefix = __,log_params,log_closure_coords)]
            // // No any other attrs.
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "  __::trait_contents::absent_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // __::trait_contents::absent_af().\n",
                "__::trait_contents::noargs_af(_p: 1) {\n",
                "  __::trait_contents::noargs_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // __::trait_contents::noargs_af().\n",
                "__::trait_contents::skip_af(..) {\n",
                "  __::trait_contents::skip_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // __::trait_contents::skip_af().\n",
                "__::trait_contents::log_af(_p: 1) {\n",
                "  __::trait_contents::log_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // __::trait_contents::log_af().\n",

                "__::trait_contents::absent_m(self: &1) {\n",
                "  __::trait_contents::absent_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // __::trait_contents::absent_m().\n",
                "__::trait_contents::noargs_m(self: &1) {\n",
                "  __::trait_contents::noargs_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // __::trait_contents::noargs_m().\n",
                "__::trait_contents::skip_m(..) {\n",
                "  __::trait_contents::skip_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // __::trait_contents::skip_m().\n",
                "__::trait_contents::log_m(self: &1) {\n",
                "  __::trait_contents::log_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
...

    {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "  Tr::trait_contents::absent_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::trait_contents::absent_af().\n",
                "Tr::trait_contents::noargs_af(_p: 1) {\n",
                "  Tr::trait_contents::noargs_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::trait_contents::noargs_af().\n",
                "Tr::trait_contents::skip_af(..) {\n",
                "  Tr::trait_contents::skip_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::trait_contents::skip_af().\n",
                "Tr::trait_contents::log_af(_p: 1) {\n",
                "  Tr::trait_contents::log_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::trait_contents::log_af().\n",

                "Tr::trait_contents::absent_m(self: &1) {\n",
                "  Tr::trait_contents::absent_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // Tr::trait_contents::absent_m().\n",
                "Tr::trait_contents::noargs_m(self: &1) {\n",
                "  Tr::trait_contents::noargs_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // Tr::trait_contents::noargs_m().\n",
                "Tr::trait_contents::skip_m(..) {\n",
                "  Tr::trait_contents::skip_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::trait_contents::skip_m().\n",
                "Tr::trait_contents::log_m(self: &1) {\n",
                "  Tr::trait_contents::log_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
...

    {
        ...
        assert_eq!(
            ...
            concat!(
                "Tr::trait_contents::absent_af(..) {\n",
                "  Tr::trait_contents::absent_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::trait_contents::absent_af().\n",
                "Tr::trait_contents::noargs_af(..) {\n",
                "  Tr::trait_contents::noargs_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::trait_contents::noargs_af().\n",
                "Tr::trait_contents::skip_af(..) {\n",
                "  Tr::trait_contents::skip_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::trait_contents::skip_af().\n",
                ...
                "Tr::trait_contents::absent_m(..) {\n",
                "  Tr::trait_contents::absent_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::trait_contents::absent_m().\n",
                "Tr::trait_contents::noargs_m(..) {\n",
                "  Tr::trait_contents::noargs_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::trait_contents::noargs_m().\n",
                "Tr::trait_contents::skip_m(..) {\n",
                "  Tr::trait_contents::skip_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::trait_contents::skip_m().\n",
