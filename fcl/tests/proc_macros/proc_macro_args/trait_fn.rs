...
fn trait_fn() {
...

    {
        ...
        assert_eq!(
            ...
            concat!(
                "Tr::absent_af(_p: 1) {\n",
                "  Tr::absent_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::absent_af().\n",
                "Tr::noargs_af(_p: 1) {\n",
                "  Tr::noargs_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::noargs_af().\n",
                "Tr::skip_af(..) {\n",
                "  Tr::skip_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::skip_af().\n",
                "Tr::log_af(_p: 1) {\n",
                "  Tr::log_af::closure{", closure_coords!(), "}(x: 0) {} -> 0\n",
                "} // Tr::log_af().\n",

                "Tr::absent_m(self: &1) {\n",
                "  Tr::absent_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // Tr::absent_m().\n",
                "Tr::noargs_m(self: &1) {\n",
                "  Tr::noargs_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // Tr::noargs_m().\n",
                "Tr::skip_m(..) {\n",
                "  Tr::skip_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::skip_m().\n",
                "Tr::log_m(self: &1) {\n",
                "  Tr::log_m::closure{", closure_coords!(), "}(y: 2) {} -> 2\n",
                "} // Tr::log_m().\n",
            )
        );
        log.borrow_mut().clear();
...

    {
        ...
        assert_eq!(
            ...
            concat!(
                "Tr::absent_af(..) {\n",
                "  Tr::absent_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::absent_af().\n",
                "Tr::noargs_af(..) {\n",
                "  Tr::noargs_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::noargs_af().\n",
                "Tr::skip_af(..) {\n",
                "  Tr::skip_af::closure{", dots!(), "}(..) {} -> 0\n",
                "} // Tr::skip_af().\n",
                ...
                "Tr::absent_m(..) {\n",
                "  Tr::absent_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::absent_m().\n",
                "Tr::noargs_m(..) {\n",
                "  Tr::noargs_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::noargs_m().\n",
                "Tr::skip_m(..) {\n",
                "  Tr::skip_m::closure{", dots!(), "}(..) {} -> 2\n",
                "} // Tr::skip_m().\n",
